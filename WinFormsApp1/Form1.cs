    ...
    public partial class Form1 : Form
    {
        ...
        void Coinscolletion()
        {
            ...
            else if (_mainVehicle.getColor() == Color.blue)
            {
                ...
                if (BlueCar.Bounds.IntersectsWith(coin4.Bounds))
                {
                    collectedCoins++;
                    label1.Text = "coins=" + collectedCoins.ToString();
                    coin4.Location = new Point(x, 0);
            ...
            else if (_mainVehicle.getColor() == Color.yellow)
            {
                ...
                if (yellowCar.Bounds.IntersectsWith(coin4.Bounds))
                {
                    collectedCoins++;
                    label1.Text = "coins=" + collectedCoins.ToString();
                    coin4.Location = new Point(x, 0);
            ...
            else if (_mainVehicle.getColor() == Color.green)
            {
                ...
                if (greenMotor.Bounds.IntersectsWith(coin4.Bounds))
                {
                    collectedCoins++;
                    label1.Text = "coins=" + collectedCoins.ToString();
                    coin4.Location = new Point(x, 0);
            ...
            else if (_mainVehicle.getColor() == Color.purple)
            {
                ...
                if (purpleMotor.Bounds.IntersectsWith(coin4.Bounds))
                {
                    collectedCoins++;
                    label1.Text = "coins=" + collectedCoins.ToString();
                    coin4.Location = new Point(x, 0);
